...
import com.hail.leddemo.entity.LEDRecommendColor;
import com.hail.leddemo.entity.LEDRecommendColorManager;
...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, RadioGroup.OnCheckedChangeListener, AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.fontcolor_btn_led: //字体颜色
                showColorPicker(true);
            case R.id.bgcolor_btn_led:
                showColorPicker(false); //背景颜色
                break;
            case R.id.recommendcolor_btn_led://推荐颜色
                showRecommendColorDialog();
                break;
            case R.id.reverseColor_led:  ///刷新
